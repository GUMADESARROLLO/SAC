    ...
    */
    ...
    'connections' => [
        ...
        'mysql_gnet_pro' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL_03'),
            'host' => env('DB_HOST_GNET', '127.0.0.1'),
            'port' => env('DB_PORT_GNET', '3306'),
            'database' => env('DB_DATABASE_GNET', 'forge'),
            'username' => env('DB_USERNAME_GNET', 'forge'),
            'password' => env('DB_PASSWORD_GNET', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
