            ...
            <div class="modal-content border">
              <div class="modal-content border">
                  ...
                  <div class="mb-3">
                      ...
                      <input class="form-control datetimepicker" id="timepicker_ini" type="text" placeholder="H:i" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":true}' />
                  </div>
                  <div class="mb-3">
                      <label class="fs-0" for="eventEndDate">Hora Fin</label>
                      <input class="form-control datetimepicker" id="timepicker_end" type="text" placeholder="H:i" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":true}' />
                  </div>
                  <div class="mb-3">
